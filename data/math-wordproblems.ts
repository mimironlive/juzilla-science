...
const questions: MathQuestion[] = [
...

  {
    ...
    answer: 192,
    hint: 'Multiply the number of rows by the number of chairs in each row.',
  },
  {
    id: 'wp-2',
    question: 'Ali saves $7 every week.\nHow much money does he save in 9 weeks?',
    answer: 63,
    hint: 'Multiply the amount saved each week by the number of weeks.',
  },
  {
    id: 'wp-3',
    question: 'Siti packs 36 cookies into each box.\nShe fills 6 boxes.\nHow many cookies does she pack in total?',
    answer: 216,
    hint: 'Multiply the number of cookies per box by the number of boxes.',
  },
  {
    id: 'wp-4',
    question: 'A hawker stall sells 48 bowls of noodles each day.\nHow many bowls does it sell in 7 days?',
    answer: 336,
    hint: 'Multiply the number of bowls per day by the number of days.',
  },
  {
    id: 'wp-5',
  ...
  },
  {
    ...
    answer: 476,
    hint: 'Multiply the number of beads per bracelet by the number of bracelets.',
  },
  {
    id: 'wp-23',
    question: 'A bus company has 6 buses.\nEach bus makes 37 trips in a week.\nHow many trips do all the buses make in a week?',
    answer: 222,
    hint: 'Multiply the number of trips per bus by the number of buses.',
  },
  {
    id: 'wp-24',
    ...
    answer: 920,
    hint: 'Multiply the number of oranges per bag by the number of bags.',
  },
  {
    id: 'wp-25',
    question: 'Each floor of a HDB block has 9 flats.\nThe block has 32 floors.\nHow many flats are there in the block?',
    answer: 288,
    hint: 'Multiply the number of flats per floor by the number of floors.',
  },
  ...
  },
  {
    ...
    answer: 35,
    hint: 'Divide the total number of chairs by the number of chairs in each row.',
  },
  {
    id: 'wp-31',
    question: 'Ravi collects 216 cans for a recycling drive.\nHe packs them into bags of 6.\nHow many bags does he fill?',
    answer: 36,
    hint: 'Divide the total number of cans by the number of cans per bag.',
  },
  {
    id: 'wp-32',
  ...
  },
  {
    ...
    answer: 56,
    hint: 'Divide the total books by the number of classes.',
  },
  {
    id: 'wp-36',
    question: 'Beng saves $7 every week.\nHe wants to save $224 in total.\nHow many weeks will it take him to reach his goal?',
    answer: 32,
    hint: 'Divide the total amount to save by the amount saved each week.',
  },
  {
    id: 'wp-37',
  ...
  },
  {
    ...
    answer: 70,
    hint: 'Divide the total plates by the number of days.',
  },
  ...
  },
  {
    ...
    answer: 6,
    hint: 'Divide 61 by 9 and look at the whole number part.',
  },
  {
    id: 'wp-64',
    ...
    answer: 7,
    hint: 'Divide 61 by 9 and find the remainder.',
  },
  {
    id: 'wp-65',
    ...
    answer: 1,
    hint: 'Divide 97 by 6 and find the remainder.',
  },
...

  {
    ...
    answer: 36,
    hint: 'First multiply to find the total sweets, then subtract the sweets given away.',
  },
  {
    id: 'wp-67',
    question: 'A bakery makes 7 trays of cookies with 12 cookies each.\nThey sell 43 cookies.\nHow many cookies are left?',
    answer: 41,
    hint: 'First multiply to find the total cookies, then subtract the cookies sold.',
  },
  {
    id: 'wp-68',
    question: 'Ali buys 8 boxes of pens.\nEach box has 6 pens.\nHe gives 15 pens to his classmates.\nHow many pens does he have left?',
    answer: 33,
    hint: 'First multiply to find the total pens, then subtract the pens given away.',
  },
  {
    id: 'wp-69',
    ...
    answer: 17,
    hint: 'First divide to find how many each friend gets, then add the extra marbles.',
  },
  {
    id: 'wp-70',
    ...
    answer: 45,
    hint: 'First multiply to find the total weight, then subtract the amount used.',
  },
  {
    id: 'wp-71',
    ...
    answer: 8,
    hint: 'First divide to find how many cans per day, then subtract the cans given away.',
  },
  {
    id: 'wp-72',
    question: 'A pasar malam stall has 7 rows of toys.\nEach row has 25 toys.\nAfter selling 63 toys, how many toys are left?',
    answer: 112,
    hint: 'First multiply to find the total toys, then subtract the toys sold.',
  },
  {
    id: 'wp-73',
    question: 'Siti saves $8 a week for 9 weeks.\nShe spends $34 on a book.\nHow much money does she have left?',
    answer: 38,
    hint: 'First multiply to find total savings, then subtract the amount spent.',
  },
  {
    id: 'wp-74',
    ...
    answer: 14,
    hint: 'First divide to find the number per row. The extra row has 14 saplings.',
  },
  {
    id: 'wp-75',
    ...
    answer: 7,
    hint: 'First multiply to find the total plates sold, then divide the earnings by that number.',
  },
  {
    id: 'wp-76',
    ...
    answer: 189,
    hint: 'Multiply to find the cans in the bags, then add the leftover cans.',
  },
  {
    id: 'wp-77',
    ...
    answer: 81,
    hint: 'First multiply to find the total cards, then subtract the cards traded away.',
  },
  {
    id: 'wp-78',
  ...
  },
  {
    ...
    answer: 152,
    hint: 'Multiply to find the stamps on the filled pages, then add the leftover stamps.',
  },
  {
    id: 'wp-80',
    ...
    answer: 288,
    hint: 'Multiply the number of trips by the number of pupils per trip.',
  },
  ...
  },
  {
    ...
    answer: 63,
    hint: 'Multiply the price of each pen by the number of pens.',
  },
  {
    id: 'wp-83',
    ...
    answer: 72,
    hint: 'Divide the total volume by the number of smaller tanks.',
  },
  {
    id: 'wp-84',
    question: 'Mr Lim jogs 8 km every morning.\nHow many kilometres does he jog in 45 days?',
    answer: 360,
    hint: 'Multiply the distance jogged each day by the number of days.',
  },
  {
    id: 'wp-85',
    ...
    answer: 252,
    hint: 'Multiply the time per trip by the number of days.',
  },
  {
    id: 'wp-86',
  ...
  },
  {
    ...
    answer: 24,
    hint: 'Divide the total amount by the number of shops.',
  },
  {
    id: 'wp-88',
    ...
    answer: 40,
    hint: 'First find the total minutes, then divide by the number of performances.',
  },
  {
    id: 'wp-89',
  ...
  },
  {
    ...
    answer: 48,
    hint: 'Divide the total volume by the amount pumped out each minute.',
  },
